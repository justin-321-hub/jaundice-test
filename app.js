...
const LANG_KEY = "fourleaf_language";

const WELCOME_MESSAGES = {
  "繁體中文": "<p><span style=\"color: #0056b3; font-weight: bold;\">您好！歡迎使用新生兒黃疸居家照護衛教資訊服務 🏥</span> 寶寶皮膚黃黃的讓您擔心了嗎？我是您的專屬小幫手，可以為您解答關於生理性/病理性黃疸、母乳哺餵與大便顏色觀察等衛教知識。請問今天想了解什麼呢？📋🩺</p>",
  "English": "<p><span style=\"color: #0056b3; font-weight: bold;\">Hello! Welcome to the Newborn Jaundice Home Care Education Service 🏥</span> Is your baby's skin looking yellow? I'm here to help answer your questions about physiological/pathological jaundice, breastfeeding, and stool color. What would you like to know today? 📋🩺</p>",
  "印尼文": "<p><span style=\"color: #0056b3; font-weight: bold;\">Halo! Selamat datang di Layanan Edukasi Perawatan Bayi Baru Lahir dengan Penyakit Kuning 🏥</span> Apakah kulit bayi Anda terlihat kuning? Saya siap membantu menjawab pertanyaan Anda tentang jaundice fisiologis/patologis, menyusui, dan warna tinja. Apa yang ingin Anda ketahui hari ini? 📋🩺</p>",
  "越南文": "<p><span style=\"color: #0056b3; font-weight: bold;\">Xin chào! Chào mừng bạn đến với Dịch vụ Giáo dục Chăm sóc Trẻ Sơ sinh Bị Vàng Da 🏥</span> Da của bé có vẻ vàng khiến bạn lo lắng? Tôi ở đây để giải đáp các câu hỏi về vàng da sinh lý/bệnh lý, cho con bú và màu sắc phân. Hôm nay bạn muốn tìm hiểu điều gì? 📋🩺</p>",
};

function getSavedLanguage() {
  return localStorage.getItem(LANG_KEY) || "繁體中文";
}
...
if (elLangSelect) {
  ...
  elLangSelect.addEventListener("change", () => {
    currentLanguage = elLangSelect.value;
    localStorage.setItem(LANG_KEY, currentLanguage);
    messages.length = 0;
    messages.push({ id: uid(), role: "assistant", text: WELCOME_MESSAGES[currentLanguage], ts: Date.now() });
    render();
  });
}
